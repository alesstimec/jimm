...
type JujuManager interface {
	...
	RecoverModelCredential(ctx context.Context, user *openfga.User, tag names.CloudCredentialTag) error
	RecoverAllModelCredentials(ctx context.Context, user *openfga.User) ([]juju.RecoverModelCredentialResult, error)
