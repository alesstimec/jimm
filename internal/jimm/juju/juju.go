...
func (j *JujuManager) dial(ctx context.Context, user *openfga.User, ctl *dbmodel.Controller, modelTag names.ModelTag, permissons ...permission) (API, error) {
	...
	return j.Dialer.Dial(ctx, user, ctl, modelTag, permissionMap)
}
